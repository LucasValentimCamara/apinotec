...
<body>
	...
	<div class="contact agileits">
		<div class="container"> 
			<h2 class="agileits-title">Obrigado por avaliar os nossos serviços</h2>
			<!--<h4 class="agileits-title">Obrigado por avaliar</h4>-->
...
SQL="Insert into tabela2 (nome,email,mensagem,data,nota) values('"& nome &"','"& email &"','"& mensagem &"',#" & now & "#, "& nota &")"
