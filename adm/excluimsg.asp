...
<body>
	...
	<div class="courses">
		<div class="container"> 
		<h2 class="agileits-title">Excluir registros</h2> 
...
response.write ("<tr>")
response.write ("<td>")
response.write ("<a href= apagamsg.asp?codigo="&rs("codigo") & " >" & rs("nome") & "</a>")
...
%>
		...
		<div class="container" align="center">
			<form action="mensagens.asp" method="post">
				<input  type="submit" value="Voltar para Mensagens">
			</form>
		</div>
		</div>
	</div>
