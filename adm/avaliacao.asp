...
<body>
					...
					<div class="navbar-top">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							 <ul class="nav navbar-nav link-effect-4">
								...
								<li class="active first-list"><a href="avaliacao.asp">Avaliações</a></li>
	...
	<div class="courses">
		<div class="container"> 
		<h2 class="agileits-title">Avaliações</h2> 
...
Registros.Open "tabela2",Conexao
...
response.write ("<table class='bordered striped centered'><tr><th>Nome<th>Email<th>Mensagem<th>Data/Hora<th>Nota</tr>")
